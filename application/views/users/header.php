...
<head>
	...
	<link rel="icon" type="image/png" href="foto/ft.png">
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<a class="navbar-brand" href="" style="color: #FFF;"><span class="glyphicon glyphicon-send" aria-hidden="true"></span><b>&nbsp;&nbsp; E-PURPOSE</b></a>
									...
									<li class="<?php if ($sub_menu == "pengguna") {
										...
										<ul>
											...
											<li class="<?php if ($sub_menu == "siswa") {
															echo 'active';
														} ?>"><a href="users/siswa"><i class="icon-users"></i> <b>DATA HIMPUNAN</b></a>
											</li>
											<li class="<?php if ($sub_menu == "md") {
															echo 'active';
														} ?>"><a href="users/md"><i class="icon-certificate"></i> <b>PROFIL HIMPUNAN</b></a>
											</li>
										</ul>
									</li>
									<?php
										...
										<li class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "lap_sm") {
											...
											<ul>
												...
												<li class="<?php if ($sub_menu == "lap_diklat" or $sub_menu == "data_diklat") {
																echo 'active';
															} ?>"><a href="users/lap_diklat"><i class="icon-file-text"></i> <b>DIKLAT/ACARA</b></a></li>
											</ul>
										</li>
									<?php } ?>
								<?php } ?>
