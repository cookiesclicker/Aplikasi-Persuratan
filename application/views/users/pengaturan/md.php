                    ...
                    <div class="panel-heading text-left">
                        <div class="row">
                            <div class="col-sm-6 text-left">
                                <span class="glyphicon glyphicon-home" aria-hidden="true"></span><b class="">&nbsp; PROFIL  FAKULTAS TEKNIK UJB</b><br>
                            </div>
                        </div>
                    </div>
                        ...
                        <fieldset class="content-group">
                            <form class="form-horizontal" action="" method="post">
                                <div class="form-group">
                                    <label class="control-label col-lg-2 text-right">Nama Dekan</label>
                                    <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-lg-2 text-right">Nama Kampus</label>
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-list"></i></span>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2 text-right">Tahun Jabatan</label>
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-list"></i></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-lg-2 text-right">Alamat Kampus</label>
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-list"></i></span>
